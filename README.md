...
- The lesson library now also captures "what worked": high-scoring first-pass runs distill reusable procedures, auto-injected into similar future tasks — marked with a green "Best practice" badge.
